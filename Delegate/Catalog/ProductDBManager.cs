...
namespace Catalog 
{
    ...
    {
       public static string conString = @"server=localhost;user=root;database=transflower;password='Password'";
    ...
    public static Product Get(int productId)
        {
            ...
            try
            {
                ...
                string query = "DELETE FROM Flower WHERE Id=@ProductId";
              ...
              MySqlConnection con = new MySqlConnection(conString);
                {
                    ...
                    string query = "UPDATE Flower SET Title=@Title , Description=@Description, " +
       ...
       public static bool Insert(Product product)
        {
            ...
            try
            {
                MySqlConnection con = new MySqlConnection(conString);
                {
                    if (con.State == ConnectionState.Closed)
                    con.Open();
                    string query = "INSERT INTO Flower (Id,Title, Description, ImageUrl, UnitPrice, Quantity) " +
